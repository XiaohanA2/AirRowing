...
同济大学2022级软工课设项目，一款智能赛艇应用软件。

## 小组成员信息

|  学号   |  姓名  |  联系方式   | 个人贡献占比 |
| :-----: | :----: | :---------: | :----------: |
| 2253721 | 陈茁扬 | 15005070116 |     25%      |
| 2253551 | 李沅衡 | 13127637885 |     25%      |
| 2252839 | 章卓源 | 15926752293 |     25%      |
| 2252843 | 杨宇琨 | 18186206130 |     25%      |
...
- **前端**：Vue 3 + Vite — 用于构建高效的单页应用，提供快速的开发和热重载功能。
- **后端**：Spring Boot — 提供 RESTful API 服务，支持数据处理和用户交互。
- **数据库**：MySQL — 存储用户数据和训练记录。
- **消息队列**：RocketMQ — 实现异步消息处理和事件流，提升系统的并发处理能力。
...
- **邮箱：**969587967@qq.com
- **GitHub：** [AirRowing: 同济大学2022级软工课设项目，一款移动端智能赛艇软件](https://github.com/XiaohanA2/AirRowing)
